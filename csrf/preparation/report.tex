...
by the browser. Of course, you can also use Wireshark or similar tools to as
means to capture HTTP traffic. From my experience however it comes handy to
use the builtin browser functions, since they oftentimes are nicely
integrated and fit well with the HTML/JavaScript development workflow.
\begin{figure}[h!]
	\centering
	\includegraphics[width=1.0\textwidth]
...
The \texttt{advanced-csrf-exploits} package is a simple web application designed
...
For the assignments it would be a pity if you would spent a lot of effort
into fiddling on syntax particularities, so don't be afraid to ask me
if you get stuck.
